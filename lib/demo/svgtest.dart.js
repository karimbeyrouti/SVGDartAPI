...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|DOMError|DOMParser|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["kurst.geom", "../kurst/geom.dart", , V, {
  ...
  Point: {
    ...
    toString$0: function(_) {
      return "[Point] (x=" + H.S(this.x) + " , " + H.S(this.y) + "= y)";
    }
  }
}],
["kurst.svg", "../kurst/kurstsvg.dart", , L, {
  "^": "",
  SVGDisplayObjectBase: {
    "^": "SVGObjectBase;",
    updateTransform$0: function() {
      var t1, _regx, _regy;
      t1 = this.registration;
      _regx = t1.x;
      _regy = t1.y;
      J.setAttribute$2$x(this._element, "transform", "translate( " + this._x + " ," + this._y + " ) rotate( " + this._rotation + " ," + H.S(_regx) + " , " + H.S(_regy) + " )");
    },
    remove$0: function(_) {
      var t1, l, c, t2;
      t1 = this.parentSVGObject;
      if (t1 == null)
        return;
      if (this._element.parentNode != null) {
        l = t1.children.length;
        for (c = 0; c < l; ++c) {
          t1 = this.parentSVGObject.children;
          t2 = t1.length;
          if (c >= t2)
            return H.ioore(t1, c);
          if (t1[c] === this) {
            if (c >= t2)
              H.throwExpression(P.RangeError$value(c, null, null));
            t1.splice(c, 1)[0];
          }
        }
        this.parentSVGObject = null;
        J.remove$0$ax(this._element);
      }
    },
    isChild$1: function(obj) {
      var t1, l, c, o;
      if (this.parentSVGObject == null)
        return false;
      t1 = this.children;
      l = t1.length;
      for (c = 0; c < l; ++c) {
    ...
    SVGDisplayObjectBase$0: function() {
      this.children = H.setRuntimeTypeInfo([], [L.SVGDisplayObjectBase]);
      this.registration = new V.Point(0, 0);
    }
  },
  SVGFilterBase: {
    "^": "SVGObjectBase;",
    appendFilter$1: function(SVGFilterPrimitive) {
      if (!this.containsFilter$1(SVGFilterPrimitive)) {
        this.filters.push(SVGFilterPrimitive);
        this._element.appendChild(SVGFilterPrimitive);
      }
    },
    containsFilter$1: function(SVGFilterPrimitive) {
      var t1, l, c, n;
      t1 = this.filters;
      l = t1.length;
      for (c = 0; c < l; ++c) {
        n = t1[c];
        if (n == null ? SVGFilterPrimitive == null : n === SVGFilterPrimitive)
          return true;
      }
      return false;
    }
  ...
  SVGGradientBase: {
    "^": "SVGObjectBase;",
    addStop$3: function(offset, color, opacity) {
      var t1, t2, t3;
      t1 = this._stops;
      t2 = new L.SVGGradientStop(null, null, null);
      t2.SVGGradientStop$4(this, offset, color, opacity);
      t1.push(t2);
      t2 = t1.length;
      t3 = t2 - 1;
      if (t3 < 0)
  ...
  SVGPathCommand: {
    "^": "Object;code,params,isRelative"
  },
  SVGPathCommandDef: {
    "^": "Object;code,name"
  },
  SVGArc: {
    "^": "SVGPath;_startPoint,_endPoint,_radius,_arcSweep,_startAngle,_endAngle,commands,drawOnCommand,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id",
    _polarToCartesian$5: function(centerX, centerY, radius, angleInDegrees, point) {
      var angleInRadians = (angleInDegrees - 90) * 3.141592653589793 / 180;
      point.x = centerX + radius * Math.cos(H.checkNum(angleInRadians));
      point.y = centerY + radius * Math.sin(H.checkNum(angleInRadians));
      return point;
    },
    draw$0: function() {
      ...
      t5 = this._endAngle;
      t6 = this._startPoint;
      this._polarToCartesian$5(t1, t2, t3, t5, t6);
      t7 = this._endPoint;
      this._polarToCartesian$5(t1, t2, t3, t4, t7);
      t1 = t5 - t4 <= 180 ? 0 : 1;
      this._arcSweep = t1;
      t2 = this.commands;
      t4 = t2.length;
      ...
      if (6 >= t3)
        return H.ioore(t2, 6);
      t2[6] = t7;
      L.SVGPath.prototype.draw$0.call(this);
    },
    updateTransform$0: function() {
      var t1, t2, t3, t4;
      t1 = this._x;
      t2 = this.registration;
      t3 = t2.x;
      t4 = this._y;
      t2 = t2.y;
      this.draw$0();
      J.setAttribute$2$x(this._element, "transform", "rotate( " + this._rotation + " ," + H.S(t1 + t3) + " , " + H.S(t4 + t2) + " )");
    },
    SVGArc$0: function() {
      var t1, t2, t3;
      J.setAttribute$2$x(this._element, "fill-opacity", C.JSInt_methods.toString$0(0));
      J.setAttribute$2$x(this._element, "stroke", "#000000");
      J.setAttribute$2$x(this._element, "stroke-width", C.JSInt_methods.toString$0(10));
      this.drawOnCommand = false;
      t1 = this._startPoint;
      this.addDrawCommand$2($.get$SVGPath_moveto(), [t1.x, t1.y]);
      this.drawOnCommand = true;
      t1 = $.get$SVGPath_arc();
      t2 = this._radius;
      t3 = this._endPoint;
      this.addDrawCommand$2(t1, [t2, t2, 0, this._arcSweep, 0, t3.x, t3.y]);
    }
  },
  SVGCanvas: {
    "^": "SVGDisplayObjectBase;container,svg,defs,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id",
    append$1: function(_, obj) {
      if (!this.isChild$1(obj)) {
        this.children.push(obj);
        obj.parentSVGObject = this;
        this.svg.appendChild(obj._element);
      } else
        this._element.appendChild(obj._element);
    },
    SVGCanvas$1: function(container) {
      var t1 = document.createElementNS("http://www.w3.org/2000/svg", "svg");
      this._element = t1;
      this.svg = t1;
  ...
  SVGCircle: {
    "^": "SVGDisplayObjectBase;_width,_height,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id"
  },
  SVGGroup: {
    "^": "SVGDisplayObjectBase;_width,_height,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id",
    append$1: function(_, obj) {
  ...
  SVGImage: {
    "^": "SVGDisplayObjectBase;parentSVGObject,children,registration,_x,_y,_rotation,_element,_id"
  },
  SVGPath: {
    "^": "SVGDisplayObjectBase;commands,drawOnCommand,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id",
    addDrawCommand$3: function(command, parameters, relative) {
      var t1 = this.commands;
      if (parameters != null)
        t1.push(new L.SVGPathCommand(command.code, parameters, false));
      else
        t1.push(new L.SVGPathCommand(command.code, null, false));
      if (this.drawOnCommand)
        this.draw$0();
    },
    addDrawCommand$2: function(command, parameters) {
      return this.addDrawCommand$3(command, parameters, false);
    },
    addDrawCommand$1: function(command) {
      return this.addDrawCommand$3(command, null, false);
    },
    draw$0: function() {
      var t1, t2, str, cmdL, c, cmd, code, cmdP, d;
      t1 = this.commands;
      t2 = t1.length;
      if (t2 === 0)
        J.get$attributes$x(this._element).remove$1(0, "d");
      else {
        for (str = "", cmdL = null, c = 0; c < t2; ++c) {
          if (c >= t1.length)
            return H.ioore(t1, c);
          cmd = t1[c];
          code = cmd.code;
          ...
          if (cmdP != null) {
            ...
            for (d = 0; d < cmdL; ++d) {
              if (d >= cmdP.length)
                return H.ioore(cmdP, d);
              str += " " + C.JSNumber_methods.toString$0(cmdP[d]);
            }
          }
        }
        J.setAttribute$2$x(this._element, "d", str);
      }
    },
    static: {"^": "SVGPath_moveto,SVGPath_lineto,SVGPath_hlineto,SVGPath_vlineto,SVGPath_curveto,SVGPath_smoothcurveto,SVGPath_quadratic,SVGPath_smoothquadratic,SVGPath_arc,SVGPath_close"}
  },
  SVGPolygon: {
    "^": "SVGDisplayObjectBase;points,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id",
    updatePoly$0: function() {
      var t1, l, pString, c, p, xp, yp;
      t1 = this.points;
      l = t1.length;
      for (pString = "", c = 0; c < l; ++c) {
        if (c >= t1.length)
          return H.ioore(t1, c);
        p = t1[c];
        xp = p.x;
        yp = p.y;
        pString += C.JSNumber_methods.toString$0(xp) + "," + C.JSNumber_methods.toString$0(yp) + " ";
      }
      J.setAttribute$2$x(this._element, "points", pString);
    }
  },
  SVGRectangle: {
    "^": "SVGDisplayObjectBase;_width,_height,parentSVGObject,children,registration,_x,_y,_rotation,_element,_id"
  ...
  SVGBlurFilter: {
    "^": "SVGFilterBase;feGaussianBlur,_blurX,_blurY,filters,_element,_id",
    SVGBlurFilter$0: function() {
      var t1 = document.createElementNS("http://www.w3.org/2000/svg", "feGaussianBlur");
      this.feGaussianBlur = t1;
      J.setStdDeviation$2$x(t1, this._blurX, this._blurY);
      this.appendFilter$1(this.feGaussianBlur);
    }
  },
  SVGDropShadowFilter: {
    "^": "SVGFilterBase;feBlend,feBlur,feOffset,cte,_dy,_dx,_blur,filters,_element,_id",
    SVGDropShadowFilter$0: function() {
      var t1, fa, mrgn, mrgnB, mrg;
      t1 = document.createElementNS("http://www.w3.org/2000/svg", "feOffset");
      this.feOffset = t1;
      t1.setAttribute("dx", C.JSInt_methods.toString$0(this._dx));
      this.feOffset.setAttribute("dy", C.JSInt_methods.toString$0(this._dy));
      t1 = document.createElementNS("http://www.w3.org/2000/svg", "feGaussianBlur");
      this.feBlur = t1;
      t1.setAttribute("in", "SourceAlpha");
      this.feBlur.setAttribute("stdDeviation", C.JSInt_methods.toString$0(this._blur));
      this.cte = document.createElementNS("http://www.w3.org/2000/svg", "feComponentTransfer");
      fa = document.createElementNS("http://www.w3.org/2000/svg", "feFuncA");
      fa.setAttribute("type", "linear");
      fa.setAttribute("slope", "0.65");
      this.cte.appendChild(fa);
      mrgn = document.createElementNS("http://www.w3.org/2000/svg", "feMergeNode");
      mrgnB = document.createElementNS("http://www.w3.org/2000/svg", "feMergeNode");
      mrgnB.setAttribute("in", "SourceGraphic");
      mrg = document.createElementNS("http://www.w3.org/2000/svg", "feMerge");
      mrg.appendChild(mrgn);
      mrg.appendChild(mrgnB);
      this.appendFilter$1(this.feBlur);
      this.appendFilter$1(this.feOffset);
      this.appendFilter$1(this.cte);
      this.appendFilter$1(mrg);
    }
  },
  SVGGradientStop: {
    "^": "SVGObjectBase;_gradient_ref,_element,_id",
    SVGGradientStop$4: function(gradient, offset, color, opacity) {
      var t1 = document.createElementNS("http://www.w3.org/2000/svg", "svg:stop");
      this._element = t1;
      this._gradient_ref = gradient;
      gradient._element.appendChild(t1);
      J.setAttribute$2$x(this._element, "offset", offset);
      J.setAttribute$2$x(this._element, "stop-color", color);
      J.setAttribute$2$x(this._element, "stop-opacity", C.JSNumber_methods.toString$0(opacity));
    }
  },
  SVGLinearGradient: {
    "^": "SVGGradientBase;_stops,_element,_id"
  },
  SVGLoader: {
    "^": "Object;_loadStreamController,_element,_children,_request",
    parseSVGHtmlElement$2: function(nodeList, parentGroup) {
      var addToElements, $parent, $length, t1, svgObject, c, node, t2, addToElements0;
      addToElements = parentGroup == null;
      $parent = addToElements ? this._element : parentGroup;
      $length = nodeList.length;
      for (t1 = this._children, svgObject = null, c = 0; c < $length; ++c) {
        if (c >= nodeList.length)
          return H.ioore(nodeList, c);
        node = J.clone$1$x(nodeList[c], true);
        switch (node.nodeName) {
          case "g":
            svgObject = new L.SVGGroup(null, null, null, null, null, 0, 0, 0, null, null);
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGDisplayObjectBase];
            svgObject.children = t2;
            svgObject.registration = new V.Point(0, 0);
            svgObject._element = document.createElementNS("http://www.w3.org/2000/svg", "g");
            t2 = node.childNodes;
            if (t2.length > 0)
              this.parseSVGHtmlElement$2(t2, svgObject);
            svgObject._element = node;
            $parent.append$1(0, svgObject);
            addToElements0 = addToElements;
            break;
          case "rect":
            svgObject = new L.SVGRectangle(null, null, null, null, null, 0, 0, 0, null, null);
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGDisplayObjectBase];
            svgObject.children = t2;
            svgObject.registration = new V.Point(0, 0);
            svgObject._element = document.createElementNS("http://www.w3.org/2000/svg", "rect");
            svgObject._element = node;
            $parent.append$1(0, svgObject);
            addToElements0 = true;
            break;
          case "circle":
            svgObject = new L.SVGCircle(null, null, null, null, null, 0, 0, 0, null, null);
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGDisplayObjectBase];
            svgObject.children = t2;
            svgObject.registration = new V.Point(0, 0);
            svgObject._element = document.createElementNS("http://www.w3.org/2000/svg", "circle");
            svgObject._element = node;
            $parent.append$1(0, svgObject);
            addToElements0 = true;
            break;
          case "polygon":
            t2 = [];
            t2.$builtinTypeInfo = [V.Point];
            svgObject = new L.SVGPolygon(t2, null, null, null, 0, 0, 0, null, null);
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGDisplayObjectBase];
            svgObject.children = t2;
            svgObject.registration = new V.Point(0, 0);
            svgObject._element = document.createElementNS("http://www.w3.org/2000/svg", "polygon");
            svgObject._element = node;
            $parent.append$1(0, svgObject);
            addToElements0 = true;
            break;
          case "path":
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGPathCommand];
            svgObject = new L.SVGPath(t2, true, null, null, null, 0, 0, 0, null, null);
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGDisplayObjectBase];
            svgObject.children = t2;
            svgObject.registration = new V.Point(0, 0);
            svgObject._element = document.createElementNS("http://www.w3.org/2000/svg", "path");
            svgObject._element = node;
            $parent.append$1(0, svgObject);
            addToElements0 = true;
            break;
          case "text":
            svgObject = new L.SVGText(null, null, null, 0, 0, 0, null, null);
            t2 = [];
            t2.$builtinTypeInfo = [L.SVGDisplayObjectBase];
            svgObject.children = t2;
            svgObject.registration = new V.Point(0, 0);
            t2 = document.createElementNS("http://www.w3.org/2000/svg", "text");
            svgObject._element = t2;
        ...
        if (addToElements0 && addToElements)
          t1.push(svgObject);
      }
    },
    parseSVGHtmlElement$1: function(nodeList) {
      return this.parseSVGHtmlElement$2(nodeList, null);
    },
    onDataLoaded$1: [function(responseText) {
      var t1;
      this.parseSVGHtmlElement$1(new DOMParser().parseFromString(responseText, "text/xml").documentElement.childNodes);
      t1 = this._loadStreamController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1("onSVGLoaded");
    }, "call$1", "get$onDataLoaded", 2, 0, 21],
    static: {"^": "SVGLoader_onSVGLoaded"}
  }
}],
["", "svgtest.dart", , T, {
  "^": "",
  main: [function() {
    var t1, t2;
    t1 = document.querySelector("#mainDiv");
    $.container = t1;
    t2 = new L.SVGCanvas(t1, null, null, null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t2.SVGCanvas$1(t1);
    $.scanvas = t2;
    t2._id = "svgCanvas";
    J.setAttribute$2$x(t2._element, "id", "svgCanvas");
    J.setAttribute$2$x($.scanvas.svg, "width", C.JSInt_methods.toString$0(800));
    J.setAttribute$2$x($.scanvas.svg, "height", C.JSInt_methods.toString$0(600));
    t2 = new L.SVGLinearGradient(H.setRuntimeTypeInfo([], [L.SVGGradientStop]), null, null);
    t1 = document.createElementNS("http://www.w3.org/2000/svg", "svg:linearGradient");
    t2._element = t1;
    $.grad = t2;
    t2._id = "TestGrad";
    t1.setAttribute("id", "TestGrad");
    J.setAttribute$2$x($.grad._element, "x1", "0%");
    J.setAttribute$2$x($.grad._element, "y1", "50%");
    J.setAttribute$2$x($.grad._element, "x2", "100%");
    J.setAttribute$2$x($.grad._element, "y2", "50%");
    J.setAttribute$2$x($.grad._element, "spreadMethod", "pad");
    $.grad.addStop$3("0%", "#00ff00", 0.1);
    $.grad.addStop$3("100%", "#F0000", 1);
    t1 = new L.SVGDropShadowFilter(null, null, null, null, 3, 3, 3, H.setRuntimeTypeInfo([], [P.SvgElement]), null, null);
    t1._element = document.createElementNS("http://www.w3.org/2000/svg", "filter");
    t1.SVGDropShadowFilter$0();
    $.dFilter = t1;
    t1._id = "SVGDropShadowFilterTest";
    J.setAttribute$2$x(t1._element, "id", "SVGDropShadowFilterTest");
    t1 = new L.SVGBlurFilter(null, 1, 1, H.setRuntimeTypeInfo([], [P.SvgElement]), null, null);
    t1._element = document.createElementNS("http://www.w3.org/2000/svg", "filter");
    t1.SVGBlurFilter$0();
    $.bFilter = t1;
    t1._id = "SVGBlurFilterTest";
    J.setAttribute$2$x(t1._element, "id", "SVGBlurFilterTest");
    t1 = new L.SVGGroup(null, null, null, null, null, 0, 0, 0, null, null);
    t1.SVGDisplayObjectBase$0();
    t1._element = document.createElementNS("http://www.w3.org/2000/svg", "g");
    $.rectGroup = t1;
    t1 = new L.SVGRectangle(null, null, null, null, null, 0, 0, 0, null, null);
    t1.SVGDisplayObjectBase$0();
    t1._element = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    $.rect = t1;
    t1._x = 10;
    t1.updateTransform$0();
    t1 = $.rect;
    t1._y = 10;
    t1.updateTransform$0();
    t1 = $.rect;
    t1._width = 200;
    J.setAttribute$2$x(t1._element, "width", C.JSInt_methods.toString$0(200));
    t1 = $.rect;
    t1._height = 200;
    J.setAttribute$2$x(t1._element, "height", C.JSInt_methods.toString$0(200));
    J.setAttribute$2$x($.rect._element, "stroke", "#ff0000");
    J.setAttribute$2$x($.rect._element, "stroke-width", C.JSInt_methods.toString$0(2));
    t1 = $.rect;
    t2 = $.grad;
    if (t1._element != null) {
      t2 = "url(#" + H.S(t2._id) + ")";
      J.setAttribute$2$x(t1._element, "fill", t2);
    }
    t1 = $.rect;
    t2 = $.dFilter;
    J.setAttribute$2$x(t1._element, "filter", "url(#" + H.S(t2._id) + ")");
    t2 = new L.SVGRectangle(null, null, null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t2._element = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    $.rectb = t2;
    t2._x = 30;
    ...
    t2 = $.rectb;
    t2._width = 200;
    J.setAttribute$2$x(t2._element, "width", C.JSInt_methods.toString$0(200));
    t2 = $.rectb;
    t2._height = 200;
    J.setAttribute$2$x(t2._element, "height", C.JSInt_methods.toString$0(200));
    J.setAttribute$2$x($.rectb._element, "fill-opacity", C.JSDouble_methods.toString$0(0.5));
    J.setAttribute$2$x($.rectb._element, "stroke", "#ff0000");
    J.setAttribute$2$x($.rectb._element, "stroke-width", C.JSInt_methods.toString$0(2));
    J.setAttribute$2$x($.rectb._element, "rx", C.JSInt_methods.toString$0(10));
    J.setAttribute$2$x($.rectb._element, "ry", C.JSInt_methods.toString$0(10));
    J.setAttribute$2$x($.rectb._element, "fill", "#00ff00");
    t2 = J.get$onClick$x($.rectb._element);
    ...
    t2 = new L.SVGCircle(null, null, null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t1 = document.createElementNS("http://www.w3.org/2000/svg", "circle");
    t2._element = t1;
    $.circle = t2;
    t1.setAttribute("r", C.JSInt_methods.toString$0(20));
    t1 = $.circle;
    t1._x = 100;
    t1.updateTransform$0();
    t1 = $.circle;
    t1._y = 100;
    t1.updateTransform$0();
    J.setAttribute$2$x($.circle._element, "fill", "#0000ff");
    t1 = new L.SVGImage(null, null, null, 0, 0, 0, null, null);
    t1.SVGDisplayObjectBase$0();
    t2 = document.createElementNS("http://www.w3.org/2000/svg", "image");
    t1._element = t2;
    $.image = t1;
    t2.setAttributeNS("http://www.w3.org/1999/xlink", "href", "assets/apps_icon.png");
    t2 = $.image;
    t2._x = 300;
    t2.updateTransform$0();
    t2 = $.image;
    t2._y = 300;
    t2.updateTransform$0();
    J.setAttribute$2$x($.image._element, "width", C.JSInt_methods.toString$0(22));
    J.setAttribute$2$x($.image._element, "height", C.JSInt_methods.toString$0(23));
    t2 = new L.SVGPath(H.setRuntimeTypeInfo([], [L.SVGPathCommand]), true, null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t2._element = document.createElementNS("http://www.w3.org/2000/svg", "path");
    $.tripath = t2;
    t2.addDrawCommand$2($.get$SVGPath_moveto(), [75, 0]);
    $.tripath.addDrawCommand$2($.get$SVGPath_lineto(), [75, 200]);
    $.tripath.addDrawCommand$2($.get$SVGPath_lineto(), [255, 200]);
    $.tripath.addDrawCommand$1($.get$SVGPath_close());
    J.setAttribute$2$x($.tripath._element, "fill", "#ff0000");
    t2 = new L.SVGPolygon(H.setRuntimeTypeInfo([], [V.Point]), null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t2._element = document.createElementNS("http://www.w3.org/2000/svg", "polygon");
    $.poly = t2;
    t2._x = 100;
    t2.updateTransform$0();
    t2 = $.poly;
    ...
    t2.updateTransform$0();
    t2 = $.poly;
    t2.points.push(new V.Point(5, 30));
    t2.updatePoly$0();
    t2 = $.poly;
    t2.points.push(new V.Point(15, 10));
    t2.updatePoly$0();
    t2 = $.poly;
    t2.points.push(new V.Point(25, 30));
    t2.updatePoly$0();
    J.setAttribute$2$x($.poly._element, "fill", "#00ff00");
    J.setAttribute$2$x($.poly._element, "stroke", "#000000");
    t2 = new L.SVGText(null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    ...
    t2._y = 300;
    t2.updateTransform$0();
    J.set$text$x($.txt._element, "Hello SVG");
    J.setAttribute$2$x($.txt._element, "font-family", "Arial");
    J.setAttribute$2$x($.txt._element, "fill", "#000000");
    t2 = $.txt;
    t1 = $.bFilter;
    J.setAttribute$2$x(t2._element, "filter", "url(#" + H.S(t1._id) + ")");
    t1 = new L.SVGArc(new V.Point(0, 0), new V.Point(0, 0), 10, 0, 0, 359.99, H.setRuntimeTypeInfo([], [L.SVGPathCommand]), true, null, null, null, 0, 0, 0, null, null);
    t1.SVGDisplayObjectBase$0();
    t1._element = document.createElementNS("http://www.w3.org/2000/svg", "path");
    t1.SVGArc$0();
    $.arc = t1;
    t1._radius = 40;
    t1.draw$0();
    J.setAttribute$2$x($.arc._element, "stroke-width", C.JSInt_methods.toString$0(11));
    t1 = $.arc;
    t1._startAngle = 0;
    t1.draw$0();
    t1 = $.arc;
    ...
    t1._previous = t1;
    t1._next = t1;
    t1 = new L.SVGLoader(t1, null, H.setRuntimeTypeInfo([], [L.SVGDisplayObjectBase]), null);
    t2 = new L.SVGGroup(null, null, null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t2._element = document.createElementNS("http://www.w3.org/2000/svg", "g");
    t1._element = t2;
    $.sloader = t1;
    t1._request = W.HttpRequest_getString("assets/ruby.svg", null, null).then$1(t1.get$onDataLoaded());
    t1 = $.sloader._loadStreamController;
    H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new T.main_closure0());
    t1 = $.scanvas;
    t2 = $.bFilter;
    t1.defs.appendChild(t2._element);
    t2 = $.scanvas;
    t1 = $.dFilter;
    t2.defs.appendChild(t1._element);
    t1 = $.scanvas;
    t2 = $.grad;
    t1.defs.appendChild(t2._element);
    $.scanvas.append$1(0, $.tripath);
    $.scanvas.append$1(0, $.rectGroup);
    $.rectGroup.append$1(0, $.rect);
    $.rectGroup.append$1(0, $.rectb);
    $.scanvas.append$1(0, $.circle);
    $.scanvas.append$1(0, $.image);
    $.scanvas.append$1(0, $.poly);
    $.scanvas.append$1(0, $.txt);
    $.scanvas.append$1(0, $.arc);
    window;
    t2 = $.bFilter;
  ...
  main_closure0: {
    ...
    call$1: function(message) {
      P.print(H.S(message));
      $.scanvas.append$1(0, $.sloader._element);
      return;
    }
  }
},
...
;(function() {
  ...
  _.$isDuration = TRUE;
  _.$isObject = TRUE;
  L.SVGGradientStop.$isObject = TRUE;
  _ = P.SvgElement;
  _.$isElement = TRUE;
  _.$isNode = TRUE;
  _.$isObject = TRUE;
  L.SVGPathCommand.$isObject = TRUE;
  _ = V.Point;
  _.$isPoint = TRUE;
  _.$isObject = TRUE;
  L.SVGDisplayObjectBase.$isObject = TRUE;
...
J.setStdDeviation$2$x = function(receiver, a0, a1) {
  return J.getInterceptor$x(receiver).setStdDeviation$2(receiver, a0, a1);
};
...
Isolate.$lazy($, "moveto", "SVGPath_moveto", "get$SVGPath_moveto", function() {
  return new L.SVGPathCommandDef("M", "Move To");
});
Isolate.$lazy($, "lineto", "SVGPath_lineto", "get$SVGPath_lineto", function() {
  return new L.SVGPathCommandDef("L", "Line To");
});
Isolate.$lazy($, "arc", "SVGPath_arc", "get$SVGPath_arc", function() {
  return new L.SVGPathCommandDef("A", "Elliptical Arc");
});
Isolate.$lazy($, "close", "SVGPath_close", "get$SVGPath_close", function() {
  return new L.SVGPathCommandDef("Z", "Close Path");
});
...
//# sourceMappingURL=svgtest.dart.js.map
