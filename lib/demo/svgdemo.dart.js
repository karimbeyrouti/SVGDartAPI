...
["dart.dom.html", "dart:html", , W, {
  ...
  EventTarget: {
    ...
    "%": "AnalyserNode|AudioGainNode|AudioNode|AudioSourceNode|GainNode|MediaStreamAudioSourceNode|RealtimeAnalyserNode;EventTarget"
  },
  File: {
    "^": "Blob;",
    $isFile: true,
...
["kurst.media", "../kurst/kurstmedia.dart", , N, {
  "^": "",
  AudioContextManager: {
    "^": "Object;_mediaEventStreamController,audioContext,audioInput,inputPoint,analyserNode,multiplier,offset,mag,freqByteData",
    getBin$3: function(bin, numBars, groupAverage) {
      var t1, j, t2, t3, t4;
      t1 = this.analyserNode.frequencyBinCount;
      if (typeof t1 !== "number")
        return t1.$div();
      t1 /= numBars;
      this.multiplier = t1;
      t1 = C.JSNumber_methods.toInt$0(Math.floor(bin * t1));
      this.offset = t1;
      this.mag = 0;
      if (groupAverage) {
        j = 0;
    ...
    static: {"^": "AudioContextManager_onAudioStreamInitialized"}
  },
  UserMediaManager: {
    "^": "Object;_mediaEventStreamController,_audioStream",
    audioStreamInitialized$1: [function(stream) {
      var t1;
      this._audioStream = stream;
      t1 = this._mediaEventStreamController;
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1("onAudioStreamInitialized");
    }, "call$1", "get$audioStreamInitialized", 2, 0, 23],
    static: {"^": "UserMediaManager_onAudioStreamInitialized"}
  }
}],
["kurst.svg", "../kurst/kurstsvg.dart", , L, {
  ...
  SVGDisplayObjectBase: {
    ...
    updateTransform$0: function() {
      ...
      _regx = t1.x;
      _regy = t1.y;
      this._element.setAttribute("transform", "translate( " + H.S(this._x) + " ," + H.S(this._y) + " ) rotate( " + this._rotation + " ," + _regx + " , " + _regy + " )");
    },
...
["", "svgdemo.dart", , Q, {
  ...
  main: [function() {
    var t1, t2, c, rect, t3;
    t1 = new N.UserMediaManager(P.StreamController_StreamController$broadcast(null, null, false, null), null);
    $.userMediaManager = t1;
    J.getUserMedia$2$audio$video$x(window.navigator, true, false).then$1(t1.get$audioStreamInitialized());
    t1 = $.userMediaManager._mediaEventStreamController;
    H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new Q.main_closure());
    t1 = document.body;
    ...
    $.scanvas = t2;
    t2._id = "svgCanvas";
    t2._element.setAttribute("id", "svgCanvas");
    t2 = $.scanvas;
    t1 = window.innerWidth;
    t2.svg.setAttribute("width", J.toString$0(t1));
    t1 = $.scanvas;
    t2 = window.innerHeight;
    t1.svg.setAttribute("height", J.toString$0(t2));
    t2 = new L.SVGRectangle(null, null, null, null, null, 0, 0, 0, null, null);
    t2.SVGDisplayObjectBase$0();
    t1 = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    t2._element = t1;
    $.backgroundRect = t2;
    t1.setAttribute("fill", "#000000");
    $.scanvas.append$1(0, $.backgroundRect);
    ...
    for (c = 0; c < $.numBars; ++c) {
      rect = new L.SVGRectangle(null, null, null, null, null, 0, 0, 0, null, null);
      t1 = [];
      t1.$builtinTypeInfo = [L.SVGDisplayObjectBase];
      rect.children = t1;
      rect.registration = new V.Point(0, 0);
      t1 = document.createElementNS("http://www.w3.org/2000/svg", "rect");
      rect._element = t1;
      ...
      t3 = (t2 - t3) / t3;
      rect._width = t3;
      t1.setAttribute("width", C.JSInt_methods.toString$0(t3));
      rect._height = 10;
      t1.setAttribute("height", C.JSInt_methods.toString$0(10));
      rect._x = (t3 + 1) * c;
      rect.updateTransform$0();
      $.scanvas.append$1(0, rect);
      $.get$rectangles().push(rect);
    }
    Q.onResize();
  }, "call$0", "main$closure", 0, 0, 11],
  update: [function(time) {
    var t1, i, t2, rect;
    t1 = $.audioContextManager;
    t1.analyserNode.getByteFrequencyData(t1.freqByteData);
    for (i = 0; t1 = $.numBars, i < t1; ++i) {
      t1 = $.audioContextManager.getBin$3(i, t1, true);
      $.magnitude = t1;
      t2 = $.get$rectangles();
      if (i >= t2.length)
        return H.ioore(t2, i);
      ...
      t1 = t2 * t1;
      rect._height = t1;
      rect._element.setAttribute("height", C.JSNumber_methods.toString$0(t1));
      t1 = $.backgroundRect._height;
      if (typeof t1 !== "number")
        return t1.$div();
      t2 = rect._height;
      if (typeof t2 !== "number")
    ...
    C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(Q.update$closure()));
  }, "call$1", "update$closure", 2, 0, 12],
  onResize: function() {
    var c, t1, rect, t2;
    for (c = 0; t1 = $.get$rectangles(), c < t1.length; ++c) {
      rect = t1[c];
      t1 = window.innerWidth;
      t2 = $.numBars;
      if (typeof t1 !== "number")
      ...
      t2 = t1 / t2;
      rect._width = t2;
      rect._element.setAttribute("width", C.JSInt_methods.toString$0(t2));
      rect._x = J.$mul$ns(J.$add$ns(rect._width, 1), c);
      rect.updateTransform$0();
    }
    t1 = $.scanvas;
    t2 = window.innerWidth;
    t1.svg.setAttribute("width", J.toString$0(t2));
    t2 = $.scanvas;
    t1 = window.innerHeight;
    t2.svg.setAttribute("height", J.toString$0(t1));
    t1 = $.backgroundRect;
    t1._x = 0;
    ...
    t1.updateTransform$0();
    t1 = $.backgroundRect;
    t2 = P.num_parse($.scanvas.svg.getAttribute("width"), null);
    t1._width = t2;
    t1._element.setAttribute("width", J.toString$0(t2));
    t2 = $.backgroundRect;
    t1 = P.num_parse($.scanvas.svg.getAttribute("height"), null);
    t2._height = t1;
    t2._element.setAttribute("height", J.toString$0(t1));
  },
  main_closure: {
    "^": "Closure:0;",
    call$1: function(message) {
      ...
      t1 = new N.AudioContextManager(t1, t2, null, null, null, null, null, null, null);
      t1.inputPoint = J.createGain$0$x(t2);
      $.audioContextManager = t1;
      t2 = t2.createMediaStreamSource($.userMediaManager._audioStream);
      t1.audioInput = t2;
      t2.connect(t1.inputPoint, 0, 0);
      t1 = $.audioContextManager;
      t2 = t1.audioContext.createAnalyser();
      t1.analyserNode = t2;
      t2.fftSize = 2048;
      t2 = t2.frequencyBinCount;
      if (typeof t2 !== "number" || Math.floor(t2) !== t2)
        H.throwExpression(P.ArgumentError$("Invalid length " + H.S(t2)));
      t1.freqByteData = new Uint8Array(t2);
      t1.inputPoint.connect(t1.analyserNode, 0, 0);
      t1.analyserNode;
      if (!$.rafEnabled) {
        t1 = window;
        C.Window_methods._ensureRequestAnimationFrame$0(t1);
...
Isolate.$lazy($, "rectangles", "rectangles", "get$rectangles", function() {
  return H.setRuntimeTypeInfo([], [L.SVGRectangle]);
});
...
//# sourceMappingURL=svgdemo.dart.js.map
